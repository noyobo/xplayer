...
gallery/xplayer/1.1/plugin/status
gallery/xplayer/1.1/plugin/audio
gallery/xplayer/1.1/plugin/audioSwf
gallery/xplayer/1.1/index
 ...
 */
KISSY.add('gallery/xplayer/1.1/plugin/status',function(S) {
 ...
 * @extends {KISSY.Base}
 **/
KISSY.add('gallery/xplayer/1.1/plugin/audio',function(S, Base, Status) {
 ...
 * @extends {KISSY.Base}
 **/
KISSY.add('gallery/xplayer/1.1/plugin/audioSwf',function(S, Base, Swf, Status) {
