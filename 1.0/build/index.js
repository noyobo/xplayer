...
gallery/xplayer/1.0/plugin/status
gallery/xplayer/1.0/plugin/audio
gallery/xplayer/1.0/plugin/audioSwf
gallery/xplayer/1.0/index
 ...
 */
KISSY.add('gallery/xplayer/1.0/plugin/status',function(S) {
 ...
 * @extends {KISSY.Base}
 **/
KISSY.add('gallery/xplayer/1.0/plugin/audio',function(S, Base, Status) {
 ...
 * @extends {KISSY.Base}
 **/
KISSY.add('gallery/xplayer/1.0/plugin/audioSwf',function(S, Base, Swf, Status) {
 ...
 */
KISSY.add('gallery/xplayer/1.0/index',function(S, Node, PlayerAudio, PlayerSwf) {
    'use strict';
    var EMPTY = '';
    var $ = Node.all;
    /**
